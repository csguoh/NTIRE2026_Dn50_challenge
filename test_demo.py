...
def select_model(args, device):
    ...
    if model_id == 0:
        ...
        ###### run Restormer
        from models.team07_I2WM_JNU.io_restormer import get_model as Restormer
        name, data_range = f"{model_id:02}_I2WM_JNU", 1.0
        model_path = os.path.join('model_zoo/team07_I2WM_JNU', 'restormer.pth')
        model = Restormer()
        ...
        from models.team13_Restormer import Restormer

        name, data_range = f"{model_id:02}_Restormer", 1.0
        model_path = os.path.join('model_zoo', '13_Restormer.pth')
